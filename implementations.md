...
- [e-teaching.org](https://e-teaching.org)
    - s. den auf https://www.e-teaching.org/oer-sitemap.xml gelisteten Seiten. Dort befindet sich eingebettetes JSON-LD nach AMB
...
- [Open Educational Resource Search Index (OERSI)](https://oersi.org)
    - Empfhielt AMB zur Besreitstellung der Daten
    - Liefert AMB für bereitgestellte Datensätze
- [Open Music Academy](https://openmusic.academy/)
    - Bereitstelung der eigenen Daten nach AMB
- [Serlo](https://serlo.org)
    -s. https://en.serlo.org/metadata
- [WirLernenOnline](https://wirlernenonline.de):
    - Empfhielt AMB zur Bereitstellung der Daten
